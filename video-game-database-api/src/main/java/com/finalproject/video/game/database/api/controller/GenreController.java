...
public class GenreController {
	...
	public ResponseEntity<Object> createGenre(@RequestBody Genre genre, @PathVariable Long videoGameNameId)
			 {
		try {
			return new ResponseEntity<Object>(service.createGenre(genre, videoGameNameId), HttpStatus.OK);
		} catch (Exception e) {
